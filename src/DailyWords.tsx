...
export const DAILY_ROOTS: (DailyRoot | null)[] = [
  ...
  dr("xen", "hon so de hon tu gen es hen xen.", "The red color of beetroot is very saturated."),
  dr("jo", "ni jo ken do nok xas o xas ki lek ten wa en ka.", "You can sleep only at night or during thunderstorms."),
  dr("xa", "je son bin coi es hen hao de ke ten bin wa hen es xa.", "The skiing is good today because the snow is very powdery."),
  dr("te", "mi xon te yo pik men nis yu.", "My shirt has pictures of fish on it."),
  dr("xai", "je dok hen xai i jo gis se en bek de jao de ta jen.", "The dog was very shy and hid behind its person's leg."),
  dr("tun", "mi men pas can i uk kus tun men ki mas xi en hu ga.", "We sang and danced to our favorite songs at the party."),

  // Rooster
  dr("poi", "mi pas co xao tu poi gos en mi pan den bak nik.", "I ate a quail egg on my burger."),
  dr("gu", "jen men ki no ken cuk gu gus en nao mos pas ta nu bes.", "Those who cannot remember the past are condemned to repeat it."),
  dr("ces", "non cen, me jen mos ces an i bus sai ki ken co.", "Before agriculture, all people had to hunt animals and gather edible plants."),
  dr("xas", "as wek mi xas ki mun xas nai es mo.", "Wake me up when September ends."),
  dr("was", "ke es was luk?", "Where is the restroom?"),
  dr("yun", "me son xas nun co es tes hun yun sai i wa pan ki es da.", "Every day lunch is curried cauliflower with poha."),

  dr("du", "mi du yo doi.", "My tummy hurts."),
  dr("ta", "mik [xin i] gi se ce a ta kas.", "Xinyi drove her car to his house."),
  dr("sak", "je gos sak es pon a gun tas den das ses nen bek.", "This wine was bottled sixteen years ago."),
  dr("hen", "ni hen yo jis nis yuk jen men as ke ta don o jen.", "You are very good at helping people understand each other."),
  dr("kis", "yo tu ki jen men en ta kai ga i kis bok la de o jen.", "In some places people greet one another by kissing on the cheek."),
  dr("kek", "me de mi hun kek men bi en [jo ja] pis.", "All my siblings-in-law live in Georgia."),

  dr("xik", "cao xik!", "Awesome!"),
  dr("cok", "tu cok yo ok de tao mon se san bes jen i cok ek yo das jen.", "There are eight billion people on Earth and ten people in outer space."),
  dr("tus", "no tok tus so ki hai no sek!", "Don't touch the wet paint!"),
  dr("wos", "en je luk mi yak jen yo jek we nis wos tu ki hen duk.", "My neighbors here have strong opinions about compost."),
  dr("xuk", "ji un pen de je buk yo xuk.", "The first page of the book was acknowledgements."),
  dr("nuk", "je suk pan bao yo nao nuk i coi sun gos ki sek.", "This muffin has walnuts and dried cranberries."),

  dr("ka", "hen men ten wa en ka.", "It's raining heavily."),
  dr("doi", "mi yao ke mi doi es don pes we.", "I want my misfortunes to be taken seriously."),
  dr("", "", ""),
  dr("", "", ""),
  dr("", "", ""),
  dr("", "", ""),
